...
Since the Netflix documentary [*The Social Dilemma*](https://thesocialdillema.com), the "social media is bad" narrative became something that everyone understands, and at some level agrees with. But the argument presented in the documentary and what is now 
...
It's not even just "the kids" that are in trouble. I would argue adults are more at risk. Facebook has completely revamped the mobile app to favor short form, and Tiktok is increasingly popular among older demographics. 
...
*The Social Dilemma* and precursors like [*Screenagers*](https://www.screenagersmovie.com/) were created when social media apps were still dominated by networks. Instagram, for example, 
...
the recomendation distribution and people rely on dopamine from it, the more human attention is eaten away. Short form content
is an exploit on the human brain. Some people know that and some don't. But most people aren't doing anything about it. If nothing 
is ever done, then why wouldn't this problem even worse societal affects than cigarettes?

And? If the Social Dilemma showed me anything, it's that it's very easy to point at the problem and get people to understand, but 
much different to offer a solution. 

-- unfinished --

The obvious solution is to say "let's quit!". This is my personal goal. And the reason I built NAME. While obvious, I think it's actually
contrarian to belive this is a reasonble outcome. 

The middleground is to build algorithm-less social media with no short form content. I think this is also possible by building something that 
lives on top of Instagram, etc. People like to be connected that's great.
